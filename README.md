В этом примере представлен аналог unix pipeline:
...
Декомпозиция задачи:
* Написание функции ExecutePipeline которая обеспечивает конвейерную обработку функций-воркеров.
* Написание нескольких функций, которые считают некую условную хеш-сумму от входных данных
